...
local Config = require "cyberpunk.config"
local C = require "cyberpunk.palette"
...
function M.setup()
  local Treesitter = require "cyberpunk.highlights.Treesitter"
  local markdown = require "cyberpunk.highlights.markdown"
  local Whichkey = require "cyberpunk.highlights.Whichkey"
  local Notify = require "cyberpunk.highlights.Notify"
  local Git = require "cyberpunk.highlights.Git"
  local LSP = require "cyberpunk.highlights.LSP"
  local Diff = require "cyberpunk.highlights.Diff"
